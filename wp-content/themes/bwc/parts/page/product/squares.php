...
if (is_home()) {
    ...
    $include_title  = get_field('squares_includetitle', PAGE_ID_BLOG);
} else {
    $squares = get_field('squares');
    $include_title  = get_field('squares_includetitle');
}
...
$section_title      = get_field('squares_title');
$section_subtitle   = get_field('squares_subtitle');
$section_content    = get_field('squares_content');
?>
    ...
    foreach ($squares as $square):
        ...
        ?>">
            <div class="square-content col-center">
                ...
                <a <?php if ($square['button_popup']) : echo ' target="_blank" '; else : echo '  '; endif; ?> href="<?php echo $square['button_link']; ?>" class="<?php echo $extra_class; ?> btn btn-upper btn-rounded">
                    <i class="fa fa-caret-right"></i>
                    <?php echo $square['button_text']; ?></a>
                    <?php else: ?>
                <a <?php if ($square['button_popup']) : echo ' target="_blank" '; else : echo ' target="_blank" '; endif; ?> href="<?php echo $square['button_link']; ?>" class="<?php //echo $extra_class; ?> btn btn-upper"><?php echo $square['button_text']; ?></a>
                    <?php endif; ?>
                <?php endif; ?>
